                ...
                <div className='row'>
                  <div className='col-lg-4'>
                    <div className='form-group'>
                      <button
                        className='template-btn btn-bg-1 border-0 w-100'
                        type='submit'
                      >
                  ...
                  <div className='col-lg-4'>
                    <div className='form-group'>
                      <button
                        className='template-btn btn-bg-2 border-0 w-100'
                        type='submit'
                      >
                  ...
                  <div className='col-lg-4'>
                    <div className='form-group'>
                      <button
                        className='template-btn btn-bg-3 border-0 w-100'
                        type='submit'
                      >
                  ...
                  <div className='col-lg-12'>
                    <div className='input-box'>
                      <div className='form-group'>
                        ...
                        <span className='mt-1 font-size-14'>
                  ...
                  <div className='col-lg-12'>
                    <div className='btn-box'>
                      <div className='form-group text-center mb-0'>
                        <button
                          className='template-btn border-0 w-100'
                          type='submit'
                        >
                          Create my account
                        </button>
